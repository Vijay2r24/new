...
import ecom from "../../assets/images/red.jpg";
...
export const projectData = [
    ...
    {
      title: "Idea Hub",
      technologies: ["React.js", "Java", "Websockets", "SQL"],
      descriptions: [
    ...
    },
    {
      ...
      technologies: ["React.js", ".Net", "Websockets", "SQL"],
      descriptions: [
        ...
        "Engineered a MultiTenant CMS, Developing customized dynamic websites through an intuitive admin interface, tailored to empower multi-tenant environments with ease."
      ],
      // imageRight:true, // Set for this project
      images:[CMS],
      imageRight:false,  // Image on the right side
    ...
    },
    {
      ...
      imageRight:true,  // Image on the right side
      useSwiper:false, // Disable Swiper
      multiImage:true, // Single image
    },
    {
      title: "Mana Mandi Mobile App",
      technologies: ["React Native", ".NET", "Android", "IOS"],
      descriptions: [
